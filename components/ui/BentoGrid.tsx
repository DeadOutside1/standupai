...
export const BentoGridItem = ({
  ...
  return (
    <div
      ...
      style={{
        background: "rgb(66,142,198)",
        backgroundImage:
          "radial-gradient(circle, rgba(66,142,198,1) 0%, rgba(179,0,255,0.76234243697479) 100%)",
      }}
    >
      <div className="group-hover/bento:translate-x-2 transition duration-200">
        ...
        <div className="font-sans font-normal text-neutral-600 text-base dark:text-neutral-300 flex justify-center items-center h-40">
          {description}
        </div>
      </div>
    </div>
